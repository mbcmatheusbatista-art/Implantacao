...
function HomePage() {
  ...
  const cards: {
    ...
    },
    {
      ...
      issues: store.calls.filter((c) => c.validationIssues.length > 0).length,
    },
  ];
  ...
  function handleConfirm(kind: ImportKind) {
    return (
      ...
      if (kind === "initial") {
        ...
        debugImport("confirm:calls:start", {
          fileName,
          sheetName,
          headerRow,
          mapping,
          ...
          title={
            openImport.kind === "initial"
              ...
              : openImport.kind === "confirmed"
                ...
                : openImport.kind === "calls"
                  ? "Importar chamados e atendimentos"
